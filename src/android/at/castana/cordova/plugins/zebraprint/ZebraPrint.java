...
public class ZebraPrint extends CordovaPlugin implements DiscoveryHandler {

    private static final String LOG_TAG = "ZebraPrint";
            ...
            public void run() {
                ...
                try {
                    ...
                    if (bluetoothAdapter.isEnabled()) {
                        ...
                        BluetoothDiscoverer.findPrinters(cordova.getActivity().getApplicationContext(), ZebraPrint.this);
                    } else {
                        Log.d(LOG_TAG, "Bluetooth is disabled...");
                        callbackContext.error("Bluetooth is not turned on.");
                    }
